...
const Sidebar = () => {
    ...
    <div className='w-full h-full grid grid-cols-[48px,1fr]'>
        <div className='bg-slate-200 w-12 h-full rounded-tr-lg rounded-br-lg py-5 text-slate-600 flex flex-col justify-between'>
            <div>
                <NavLink className={({isActive})=>`w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-slate-200 rounded ${isActive && "bg-slate-300"}`} title='chat'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <button className='w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-slate-200 rounded' onClick={handleLogout}>
                    <span title='logout' className='-ml-2'>
                        <BiLogOut
                        size={25}
                        />
                    </span>
